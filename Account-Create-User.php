              ...
              <form action="Processing.php" method="POST">
                <div class="row">
                 <div class="section-heading" align="center">
                  ...
                  <div class="col-12">
                       <div class="mb-3">
                          <label  class="form-label">เริ่มงาน</label>
                  ...
                  <div class="col-12">
                       <div class="mb-3">
                          <label  class="form-label">ประจำ Site</label>
                          <select name="Site" id="Site" class="form-control" required>
                              <option value="" selected disabled>-ประจำหน่วยงาน-</option>
                              <?php
                              $sql = "SELECT * FROM Site_tb ORDER BY Site_ID ASC";
                   ...
                   <div class="col-12" align="right">
                       <button type="submit" class="btn btn-info " <?php if($Acc_RuleAccount == 'View'){ echo 'disabled'; } ?>  name="Create_Account"> Create Account</button>
                  </div>
              </div>
              </form>
            </div>
